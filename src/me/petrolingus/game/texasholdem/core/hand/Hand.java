package me.petrolingus.game.texasholdem.core.hand;
...
public class Hand {
     ...
     */
    private final Card[] cards = new Card[MAX_NO_OF_CARDS];
     ...
     * @throws IllegalArgumentException If the array is null or the number of cards is invalid.
     */
     ...
     * @throws IllegalArgumentException If the string could not be parsed or the number of cards is
     *                                  too high.
     */
     ...
     * (the highest ranking cards first).
     *
